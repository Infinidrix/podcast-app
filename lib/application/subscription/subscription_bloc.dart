...
class SubscriptionBloc extends Bloc<SubscriptionEvent, SubscriptionState>{
  ...
  static List<Channel> channels = [
    Channel(Name: "The Nasa Channel", ImageUrl: "https://www.image.com/image.jpg", Subscribers: 200, Id: "Another Unique ID", Podcasts: []),
    Channel(Name: "Super Awesome", ImageUrl: "https://www.image.com/image.jpg", Subscribers: 300, Id: "Amaze Unique ID", Podcasts: []),
    Channel(Name: "Wooden Overcoats", ImageUrl: "https://www.image.com/image.jpg", Subscribers: 400, Id: "Super Cool Unique ID", Podcasts: []),
  ];
